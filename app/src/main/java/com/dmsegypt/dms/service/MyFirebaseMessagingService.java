...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage == null)
            return;
        int count=App.getInstance().getPrefManager().getNotificationCount()+1;
        App.getInstance().getPrefManager().setNotificationCount(count);
        ...
        if (remoteMessage.getNotification() != null) {
            ...
            showNotificationMessage(getApplicationContext(),remoteMessage.getNotification().getTitle()
                    ,remoteMessage.getNotification().getBody(), utils.getCurrentDate(),resultIntent);
        }
