 ...
 *
 * Usage: viewPager.setPageTransformer(false, new_image ReaderViewPagerTransformer(TransformType.FLOW));
 */
public class SlideViewPagerTransformer implements ViewPager.PageTransformer {
    ...
    public SlideViewPagerTransformer(TransformType transformType) {
