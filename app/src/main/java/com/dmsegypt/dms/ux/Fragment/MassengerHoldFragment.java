...
public class MassengerHoldFragment extends Fragment {
    ...
    public MassengerHoldFragment() { }

    @Override
    public View onCreateView(
            LayoutInflater inflater, ViewGroup container,
            Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_massenger_hold, container, false);
    }
    ...
    private void getData(final int height, final boolean hasAppBarLayout,final String index) {
        ...
        App.getInstance().getService().getAllMassengerOrder(username,LocaleHelper.getLanguage(getActivity()).equals("ar")? Constants.Language.AR:Constants.Language.EN,"Hold",index).enqueue(new Callback<ResponseOrder>() {
            @Override
                ...
                if(response != null){
                    if (response.body().getList().isEmpty()){
                        ...
                        if (index.equals("0")) {
                            ...
                            adapter=new MassengerHoldFragment.Adapter(getContext(), height, hasAppBarLayout, list);
    ...
    static class TwoLinesViewHolder extends RecyclerView.ViewHolder {
        ...
        final TextView hold_date;
        final AppCompatButton button_approve;
        ...
        public TwoLinesViewHolder(final View itemView) {
            ...
            hold_date=(TextView)itemView.findViewById(R.id.tv_hold_date);
            button_approve=(AppCompatButton)itemView.findViewById(R.id.button_approve);
            vipImgv=(ImageView)itemView.findViewById(R.id.vip_imgv);

        }
    }

    private class Adapter extends RecyclerView.Adapter<MassengerHoldFragment.TwoLinesViewHolder> {
        ...
        @Override
        public MassengerHoldFragment.TwoLinesViewHolder onCreateViewHolder(final ViewGroup parent, final int viewType) {
            final View view = LayoutInflater.from(getContext()).inflate(R.layout.card_item_hold, parent, false);
            final MassengerHoldFragment.TwoLinesViewHolder holder = new MassengerHoldFragment.TwoLinesViewHolder(view);
            return holder;
        }
        @Override
        public void onBindViewHolder(final MassengerHoldFragment.TwoLinesViewHolder holder, final int position) {
            ...
            if(item.getOrder_no() != null){
                holder.orderId.setText(item.getOrder_no());
            }

            if(item.getHold_time() != null){
                holder.hold_date.setText(item.getHold_time());
            }
